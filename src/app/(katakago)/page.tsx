...
import styles from '@/katakago/_styles/main.module.css'

import work01Image from '@/katakago/_assets/work01.png'
import work02Image from '@/katakago/_assets/work02.png'
...
import worksMock from '@/katakago/_assets/works-mock.png'
import docPdf from '@/katakago/_assets/doc-pdf.png'
import docTec from '@/katakago/_assets/doc-tec.png'
                ...
                <figure className={styles.workImage}>
                  <div>
                    <Photo
                      src={work01Image}
                      alt=""
                      sizes="(min-width:1181px) 1200px, 100vw"
                    />
                  </div>
                </figure>
            ...
            <div className={styles.cardWide}>
              <Link href="/works">
                ...
                <div className={styles.workDetail99}>
                  ...
                  <p>
                    制作事例の詳細とこのサイトの構成についてはこちらをご覧ください。
                  </p>
